...
Input:
    ...
    - Validation route segment files:
      ../data/sample_processed_inputs/Validation/shortcut_route/route_split_8/
    - Validation traveler attribute file with OD nodes:
      ../data/sample_processed_inputs/Validation/shortcut_route/traveler_proper_OD_8.csv
...
VAL_ROUTE_DIR = "../data/sample_processed_inputs/Validation/shortcut_route/route_split_8/"
VAL_PROP_CSV  = "../data/sample_processed_inputs/Validation/shortcut_route/traveler_proper_OD_8.csv"
