...
Input:
    - Model checkpoints saved by the training script:
      ../expected_findings/code7_weight_for_test/weight_16/model_epoch_{epoch}.pth
    - Hexagon road network graph:
      ../data/new_hexagraph/hexa_network_with_road.gpickle
    - Validation route segment files:
      ../data/simulated_processed_inputs/Validation/shortcut_route/route_split_16/
    - Validation traveler attribute file with OD nodes:
      ../data/simulated_processed_inputs/Validation/shortcut_route/traveler_proper_OD_16.csv

Output:
    - Validation metric log:
      ./LSTM_Result/eval_metrics_16.csv
...
WEIGHT_DIR = "../expected_findings/code7_weight_for_test/weight_16/"
CKPT_PATTERN = r"model_epoch_(\d+)\.pth"
POLL_SEC = 5

GRAPH_PATH = "../data/new_hexagraph/hexa_network_with_road.gpickle"

VAL_ROUTE_DIR = "../data/simulated_processed_inputs/Validation/shortcut_route/route_split_16/"
VAL_PROP_CSV  = "../data/simulated_processed_inputs/Validation/shortcut_route/traveler_proper_OD_16.csv"

OUT_DIR = "./LSTM_Result"
os.makedirs(OUT_DIR, exist_ok=True)
METRIC_CSV = os.path.join(OUT_DIR, "eval_metrics_16.csv")
