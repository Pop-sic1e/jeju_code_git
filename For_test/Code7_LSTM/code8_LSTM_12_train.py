...
Input:
    ...
    - Training route segment files:
      ../Jeju_data/Training/shortcut_route/route_split_12/
    - Traveler attribute file with OD nodes:
      ../Jeju_data/Training/shortcut_route/traveler_proper_OD_12.csv

Output:
    - Model checkpoints:
      ../weight_for_test/weight_12/model_epoch_{epoch}.pth
...
TRAIN_ROUTE_DIR = "../Jeju_data/Training/shortcut_route/route_split_12/"
TRAIN_PROP_CSV  = "../Jeju_data/Training/shortcut_route/traveler_proper_OD_12.csv"

WEIGHT_DIR = "../weight_for_test/weight_12/"
...
# state = torch.load('./weight_12/model_epoch_60000.pth', map_location=device, weights_only=True)
